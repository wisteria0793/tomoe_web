...
def send_purchase_email(metadata):
    ...
    context = {
        ...
        # "adult_count": metadata['adult'],
        # "child_count": metadata['child'],
        # "infant_count": metadata['infant'],
    ...
    try:
        # テンプレートファイルのパス
        template_path = os.path.join(settings.BASE_DIR, 'guesthouse_tomoe/templates/shop/purchaseConfirmation.html')
